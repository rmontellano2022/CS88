...
class CheckingAccount(Account):
    ...
    def deposit_check(self, check):
        if self.holder == check.account_owner and check.deposited == False:
            check.deposited = True 
            self.balance += check.money
            return self.balance
        else: 
...
class Check(object):
    "*** YOUR CODE HERE ***"
    def __init__(self, account_owner, money):
...
class SyntaxError(Error):
    ...
    def write(self):
        ...
        "*** YOUR CODE HERE ***"
        print(Error.write(self) + ' ' + end)

    def add_code(self, code, msg):
        "*** YOUR CODE HERE ***"
        self.msgs.update({code:msg})
