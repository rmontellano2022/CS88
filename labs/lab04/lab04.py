...
def reduce(reducer, s, base):
    ...
    24
    """
    #1st step multiply base case with 1st indidce in the list using reducer 
    #2nd step use reducer as the first input and the item 2 in the list is the second input of reducer 
    #3rd step save function in new variable combination 



    for i in s:
        if reducer == mul:
            return product * i * base
        else:
            return base
