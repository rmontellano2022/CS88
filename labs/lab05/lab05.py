...
def compose(f, g):
    ...
    #In the final example above, the outer lambda (lambda x) takes in a value x, 
    #and it returns another lambda (lambda y) that takes an argument y and returns x+y
